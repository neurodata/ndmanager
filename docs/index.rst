.. meta::
   :description: Official documentation for ndmanager: Caching Gateway to connect a Visualization(e.g., CATMAID or NeuroDataviz) server to NeuroData Web Services
...
.. raw:: html
	...
	<h1>ndmanager: Caching Gateway to connect a Visualization(e.g., CATMAID or NeuroDataviz) server to NeuroData Web Services</h1>
	<br>
...
.. raw:: html
  ...
  <div>
    ...
    <span style=""></span>
    <IMG SRC="_static/GitHub.png" height="50" width="50"> <a href="https://github.com/neurodata/ndmanager/zipball/master"> [ZIP]   </a>  
    <a image="_static/GitHub.png" href="https://github.com/neurodata/ndmanager/tarball/master">[TAR.GZ] </a></p>
  </div>
...
.. toctree::
   ...
   Github repo <https://github.com/neurodata/ndmanager>
   Release Notes <https://github.com/neurodata/ndmanager/releases/>
